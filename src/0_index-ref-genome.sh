...
#SBATCH -e slurm.index.j%j.err                  # STANDARD ERROR FILE TO WRITE TO
#SBATCH -o slurm.index.j%j.out                  # STANDARD OUTPUT FILE TO WRITE TO
...
#
# sbatch 0_index-ref-genome.sh -r [reference-genome]
#-----------------------------------------------------------------------------------#
